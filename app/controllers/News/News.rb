...
class News
	...
	def getRSS(_page,_category)
		if(_category=='tintuc') 		then	@pages[_page][:tintuc]
		 elsif(_category=='kinhdoanh') 	then 	@pages[_page][:kinhdoanh]
		 elsif(_category=='thoisu') 	then	@pages[_page][:thoisu]
		 elsif(_category=='thethao')	then	@pages[_page][:thethao]
		 elsif(_category=='thegioi')	then	@pages[_page][:thegioi]	


		 elsif(_category=='giaoduc')	then	@pages[_page][:giaoduc]
		 elsif(_category=='congnghe')	then 	@pages[_page][:congnghe]
		 elsif(_category=='khoahoc')	then	@pages[_page][:khoahoc]	
		 elsif(_category=='suckhoe')	then	@pages[_page][:suckhoe]
		 elsif(_category=='congdong')	then 	@pages[_page][:congdong]

		 elsif(_category=='xe')			then 	@pages[_page][:xe]
		 elsif(_category=='startup')	then	@pages[_page][:startup]
		 elsif(_category=='giaitri')	then	@pages[_page][:giaitri]
		 elsif(_category=='dulich')		then 	@pages[_page][:dulich]
		 elsif(_category=='kinhte')		then 	@pages[_page][:kinhte]
		 elsif(_category=='vanhoa')		then 	@pages[_page][:vanhoa]
		end
	end
end
